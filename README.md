...
-  Rivisto l'ordine dei parametri dei giocatori negli array di configurazione affinchè siano coerenti gli indici 
-  Secondo step della definizione a livello logico del funzionamento della battaglia. Tramite il prosieguo dell'implementazione della funzione ```Fight()``` e la armonizzazione delle variabili con la logica stessa
